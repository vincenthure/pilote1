...
function get_capteur_accel()
    ...
    $.get   (
            ...
            function(json_data)
                ...
                document.getElementById( "mx"  ).innerHTML  = data[3].toFixed(2) 
                document.getElementById( "my"  ).innerHTML  = data[4].toFixed(2) 
                document.getElementById( "mz"  ).innerHTML  = data[5].toFixed(2)      
